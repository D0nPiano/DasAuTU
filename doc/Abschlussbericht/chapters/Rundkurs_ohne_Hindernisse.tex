...
\end{figure}
  ...
  \subsection{Kurvenerkennung}
  	Die Kurvenerkennung entspricht im Zustandsautomaten dem Übergang von der Geraden hin zur	Kurve. Wie erkennt man also eine Kurve? Verlässt man sich ausschließlich auf den 		Ultraschall-Sensor, kann man eine Kurve erst detektieren, wenn links des Fahrzeugs 	keine Wand mehr vorhanden ist. Dann befindet sich das Auto allerdings schon mitten im 			Kurvenbereich und eine vernünftige Linie kann keinesfalls mehr erreicht werden.
