#ifndef _LaserObstaclesController_H_
#define _LaserObstaclesController_H_
...
#include "autu_control/laserObstacles/curvedriver.h"
#include "autu_control/laserObstacles/curvedriver2.h"
#include "autu_control/laserObstacles/curvedriverconstant.h"
#include "autu_control/rundkurs/laserDetector.h"
#include "autu_control/rundkurs/laser_utilities.h"
#include "autu_control/laserObstacles/lowpass.h"
...
class LaserObstaclesController : public AutoController {
public:
  LaserObstaclesController(ros::NodeHandle *n, ros::Publisher *command_pub);
  ~LaserObstaclesController();
  void run();
